...
// ── CHANGELOG ─────────────────────────────────────────────────────────────────
// Entries live in changelog.js — imported above.
export { CHANGELOG };
...
export function renderGovernancePanel(ctx){
  ...
  const lines=[
    ...
    {label:'ETH',   val:`$${(G.livePrices.ETH||0).toLocaleString()}`,       color:'#62A0EA'},
    {label:'alUSD', val:`$${(G.livePrices.alUSD||1).toFixed(4)}`,           color:G.livePrices.alUSD<0.98?'#FF4444':'#4CAF50'},
    {label:'alETH', val:`$${(G.livePrices.alETH||0).toLocaleString()}`,     color:(G.livePrices.ETH>0&&Math.abs(G.livePrices.alETH-G.livePrices.ETH)/G.livePrices.ETH>0.02)?'#FF9800':'#7B68EE'},
